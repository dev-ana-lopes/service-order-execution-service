...
- Health endpoints esperados: `http://localhost:8003/health` e `http://localhost:8003/health/ready`
...
- `ghcr.io/<owner>/service-order-execution-service:<tag>` deve ser consistente entre build/push e manifests renderizados.
