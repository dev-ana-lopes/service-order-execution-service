...
class Settings(BaseSettings):
    ...
    APP_NAME: str = "service-order-execution-service"
    APP_VERSION: str = "0.1.0"
    ENVIRONMENT: Literal["development", "test", "staging", "production"] = "development"
    APP_RUNTIME_MODE: Literal["memory", "real"] = "memory"
    LOG_LEVEL: str = "INFO"
    LOG_JSON: bool = False
    APP_BASE_URL: str = "http://localhost:8003"
    ...
    RABBITMQ_ROUTING_KEY: str = "service-order.execution"
    RABBITMQ_QUEUE: str = "service-order.execution.events"
    ...
    DD_SERVICE: str = "service-order-execution-service"
    DD_ENV: str = "development"
    DD_VERSION: str = "0.1.0"
    DD_API_KEY: str = ""
    DD_TRACE_ENABLED: bool = False
    OTEL_ENABLED: bool = False
    OTEL_SERVICE_NAME: str = "service-order-execution-service"
