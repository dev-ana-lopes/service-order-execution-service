...
```bash
kubectl describe job service-order-execution-service-migrate -n service-order

kubectl logs job/service-order-execution-service-migrate -n service-order --all-containers=true
...
kubectl port-forward -n service-order svc/service-order-execution-service 8000:80
